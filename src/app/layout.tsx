...
// Configure optimized Google fonts
const inter = Inter({ 
  subsets: ["latin"], 
  variable: "--font-sans" 
});
...
export default function RootLayout({ children }: { children: React.ReactNode; }) {
  ...
  // Close mobile menu and scroll to top smoothly when navigation happens
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  return (
    <html lang="en">
      <body className={`${inter.variable} ${jetBrainsMono.variable} font-sans min-h-screen flex flex-col bg-background text-primary`}>
        <motion.div
